...
myDmenuCommand = "dmenu_run -l 10 -p \"$>\" -nb black -nf green -sb white -sf black"
...
main = do nScreens <- countScreens
          xmproc <- spawnPipe "xmobar /home/theodor/.xmobarrc"
          spawn "stalonetray -i 18 --geometry 5x1-0+0 -bg black"
          spawn "xscreensaver -no-splash &"
          spawn "feh --bg-scale /home/theodor/wallpaper1.png"
          ...
          xmonad $ defaultConfig {
                        ...
                        modMask            = mod4Mask,
                        -- numlockMask        = 0,
                        workspaces         = myWorkspaces, -- withScreens nScreens (map show [1..5]),
...
pp h s = marshallPP s defaultPP {
        ...
        ppHiddenNoWindows       = color "black",
        ppUrgent        = color "red",
        --ppSep         = color "white",
        --ppOrder               = color \(wss:layout:title:_) -> ["\NUL", title, "\NUL", wss],
